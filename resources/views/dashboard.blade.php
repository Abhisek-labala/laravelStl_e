        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="index.php" class="small-box-footer">More info <i class="fas fa-aruser-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="#" class="small-box-footer">More info <i class="fas fa-aruser-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
        ...
        <div class="card bg-light d-flex flex-fill">
          ...
          <div class="card-body pt-0">
            <div class="user">
              ...
              <img src="{{ asset('uploads/' . $user['image_url']) }}" class="img-circle img-fluid" alt="Profile Picture">
